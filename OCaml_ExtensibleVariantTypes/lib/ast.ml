...
type expr =
  ...
  | EAnonFun of expr * expr (* Anonymous function. Examples: fun x -> x + 1*)
  ...
  | EParams of expr list
    (* Parameters. Examples: let sum x y = x + y, where x, y are the parameters of the func sum *)
